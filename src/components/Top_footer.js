...
const Top_footer = () => {
  return (
    <>
      <div className='wrapper h-[70px]  text-[#2334D8] gap-5 content-center grid grid-cols-1 sm:grid-cols-2'>
        <div className='top_fotter grid sm:gap-20  content-center grid-cols-1 sm:grid-cols-2'>
...
<div className='bg-[#35EABF] mt-10 text-[#2334D8]'>
      ...
      <div className=' wrapper py-5  gap-2 sm:gap-5 grid grid-cols-1 sm:grid-cols-5'>
